...
public class SpecificationOptionServiceImpl implements SpecificationOptionService {
	...
	public PageResult findPage(int pageNum, int pageSize) {
		...
		List<TbSpecificationOption> results = specificationOptionMapper.selectByExample(null);
		PageInfo<TbSpecificationOption> pageInfo = new PageInfo<>(results);
		List<TbSpecificationOption> list = pageInfo.getList();
	...
	public PageResult findPage(TbSpecificationOption specificationOption, int pageNum, int pageSize) {
		...
		if(specificationOption!=null){			
			...
			List<TbSpecificationOption> results = specificationOptionMapper.selectByExample(example);
			PageInfo<TbSpecificationOption> pageInfo = new PageInfo<>(results);
			List<TbSpecificationOption> list = pageInfo.getList();
			long total = pageInfo.getTotal();
			return new PageResult(total,list);
